...
export const Modal = ({ children, close }: ModalProps) => {
  ...
  return (
    <div className="modal-wrapper fixed h-full w-full z-99 flex items-center justify-center">
      <div className="relative rounded-md min-h-1/2 min-w-1/2 bg-black border-2 border-primary text-primary text-center">
