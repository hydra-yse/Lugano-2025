...
export const closure417_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h728edf1b05ca97db: (a: number, b: number) => void;
export const closure984_externref_shim: (a: number, b: number, c: any, d: any) => void;
